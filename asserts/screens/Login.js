  ...
  render() {
    return (
      <View style={auth_style.container}>
        <ImageBackground
          source={{
            uri: 'https://images.unsplash.com/photo-1517433367423-c7e5b0f35086?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8OHx8Zm9vZCUyMGJhY2tncm91bmR8ZW58MHx8MHx8&auto=format&fit=crop&w=900&q=60',
          }}
          ...
          <KeyboardAvoidingView ref={'keyboardView'} style={{flex: 1}}>
